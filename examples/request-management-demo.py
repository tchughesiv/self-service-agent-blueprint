...
class RequestManagerClient:
    ...
    def __init__(self, base_url: str = "http://request-manager.llama-stack-rag.svc.cluster.local"):
...
async def demo_tool_integration():
    ...
    try:
        ...
        print(f"   This request will be routed directly to the laptop-refresh-agent")
