...
async def run_concurrent_session_requests(
    ...
    Default 1800ms to reduce reorder flakiness with 2+ replicas and cross-pod races.
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        type=float,
        default=None,
        help="Ms between sends per user (default: 1800 or STAGGER_MS env)",
    )
