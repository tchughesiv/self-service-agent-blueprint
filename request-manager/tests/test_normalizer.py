...
from request_manager.models import IntegrationType
from request_manager.normalizer import RequestNormalizer
from request_manager.schemas import SlackRequest, WebRequest, CLIRequest, ToolRequest
...
class TestRequestNormalizer:
    ...
    def test_normalize_tool_request(self):
        ...
        assert normalized.target_agent_id == "laptop-refresh-agent"  # Should map from tool
    ...
    def test_requires_routing_detection(self):
        """Test routing requirement detection."""
        # Should require routing
        routing_content = [
            "hello",
            "help me",
            "what can you do",
        ...
        for content in routing_content:
            assert self.normalizer._requires_agent_routing(content) is True

        # Short messages should require routing
        assert self.normalizer._requires_agent_routing("help") is True
        assert self.normalizer._requires_agent_routing("ok") is True
